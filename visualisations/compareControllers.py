...
if __name__ == "__main__":
    ...
    baselineStates = pd.read_csv(f"data/ruleBasedControl/{args.project}/states{args.date}-{args.seasonLength:03}.csv")
    baselineControls = pd.read_csv(f"data/ruleBasedControl/{args.project}/controls{args.date}-{args.seasonLength:03}.csv")
